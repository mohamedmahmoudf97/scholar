...
const HomeView: React.FC = ({}) => {
    return <div className="bg-white text-gray-800 font-sans antialiased">
    ...
    <section className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-500 to-blue-500 text-center text-white">
      ...
      <div className='mt-8'>
        <Link href={'#about-section'} className="mr-2 mt-8 px-6 py-3 bg-white text-purple-500 font-semibold rounded-lg hover:bg-gray-100 transition duration-200">
            Explore Now!
        </Link>
    ...
    <section className="py-20 text-center bg-gray-50" id='about-section'>
